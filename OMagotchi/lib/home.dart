  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences value) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
        setState(() {
          _avatarFuture = !firstTime ? Future.value(true) : chooseAvatar(context);
        });
      });
    });
            ...
            child: Padding(
              ...
              child: Center(
                child: FutureBuilder<bool>(
                  ...
                  builder: (context, finished) => (!(finished.data ?? false)) ? CircularProgressIndicator() : Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        '${avatar.name} is feeling ${avatar.mood}', style: Theme.of(context).textTheme.labelLarge,
                      ),
                      GestureDetector(
                        onTap: () => Navigator.of(context).push(MaterialPageRoute(
